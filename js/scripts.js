...
(function($) {
    ...
    $("#requestForm").validator().on("submit", function(event) {
    	if (event.isDefaultPrevented()) {
            ...
            rformError();
            rsubmitMSG(false, "Por favor, insira todos os dados!");
        } else {
    ...
    $("#contactForm").validator().on("submit", function(event) {
    	if (event.isDefaultPrevented()) {
            // handle the invalid form...
            cformError();
            csubmitMSG(false, "Por favor, insira todos os dados!");
        } else {
            // everything looks good!
            event.preventDefault();
            csubmitForm();
    ...
    function cformSuccess() {
        $("#contactForm")[0].reset();
        window.location.href = "http://www.afterliferp.com.br/";
        $("input").removeClass('notEmpty'); // resets the field label after submission
    ...
    $("#privacyForm").validator().on("submit", function(event) {
    	if (event.isDefaultPrevented()) {
            // handle the invalid form...
            pformError();
            psubmitMSG(false, "Por favor, insira todos os dados!");
        } else {
            // everything looks good!
            event.preventDefault();
            psubmitForm();
